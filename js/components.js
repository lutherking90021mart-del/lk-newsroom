...
export function renderHeader(active = '') {
  ...
  if (!header) return;
  header.innerHTML = `<a class="skip-link" href="#main-content">Skip to content</a><div class="topbar"><div class="container"><span><i class="fa-regular fa-calendar"></i> <span data-today></span></span><div class="topbar-links"><a href="${link('pages/about.html')}">About</a><a href="${link('pages/contact.html')}">Contact</a><a href="${link('pages/advertise.html')}">Advertise</a></div></div></div><header class="site-header"><div class="container header-main"><a href="${link('index.html')}" aria-label="LK Newsroom home"><img class="brand" src="${link('assets/lk-newsroom-logo.png')}" alt="LK Newsroom"></a><nav class="primary-nav" aria-label="Primary navigation">${links}</nav><div class="header-actions"><a class="icon-button" href="${link('pages/search.html')}" aria-label="Search"><i class="fa-solid fa-magnifying-glass"></i></a><a class="icon-button header-user" href="${link('pages/notifications.html')}" aria-label="Your notification settings"><i class="fa-regular fa-user"></i></a><button class="icon-button theme-button" id="theme-toggle" aria-label="Toggle dark mode"><i class="fa-regular fa-moon"></i></button><button class="icon-button menu-button" id="menu-toggle" aria-label="Open navigation menu" aria-controls="mobile-menu" aria-expanded="false"><i class="fa-solid fa-bars"></i></button></div></div><button class="mobile-menu-backdrop" id="mobile-menu-backdrop" aria-label="Close navigation menu" tabindex="-1"></button><nav class="mobile-menu" id="mobile-menu" aria-label="Mobile navigation"><div class="mobile-menu__heading"><strong>Explore LK Newsroom</strong><button class="icon-button" id="menu-close" aria-label="Close navigation menu"><i class="fa-solid fa-xmark"></i></button></div>${links}<a href="${link('pages/live.html')}"><span class="badge">Live</span> Live updates</a></nav></header>`;
}
...
export function renderFooter() {
  ...
  el.innerHTML = `<footer class="site-footer"><div class="container footer-main"><div><img class="footer-logo" src="${link('assets/lk-newsroom-logo.png')}" alt="LK Newsroom"><p>Independent reporting, clear context and the stories that shape our world.</p><div class="socials" aria-label="Follow LK Newsroom"><a href="https://www.facebook.com/profile.php?id=61570722200277" target="_blank" rel="noopener noreferrer" aria-label="Follow LK Newsroom on Facebook"><i class="fa-brands fa-facebook-f"></i></a><a href="https://www.instagram.com/lk.news.global/" target="_blank" rel="noopener noreferrer" aria-label="Follow LK Newsroom on Instagram"><i class="fa-brands fa-instagram"></i></a><a href="https://www.tiktok.com/@lk.news.global1" target="_blank" rel="noopener noreferrer" aria-label="Follow LK Newsroom on TikTok"><i class="fa-brands fa-tiktok"></i></a><a href="https://www.threads.com/@lk.news.global" target="_blank" rel="noopener noreferrer" aria-label="Follow LK Newsroom on Threads"><i class="fa-brands fa-threads"></i></a></div></div><div><h4>Sections</h4><ul class="footer-links">${catLinks}</ul></div><div><h4>Explore</h4><ul class="footer-links"><li><a href="${link('pages/live.html')}">Live Updates</a></li><li><a href="${link('pages/video-news.html')}">Video News</a></li><li><a href="${link('pages/gallery.html')}">Photo Gallery</a></li><li><a href="${link('pages/newsletter.html')}">Newsletter</a></li><li><a href="${link('pages/search.html')}">Search</a></li></ul></div><div><h4>Company</h4><ul class="footer-links"><li><a href="${link('pages/about.html')}">About us</a></li><li><a href="${link('pages/contact.html')}">Contact</a></li><li><a href="${link('pages/privacy.html')}">Privacy policy</a></li><li><a href="${link('pages/terms.html')}">Terms of use</a></li><li><a href="${link('pages/advertise.html')}">Advertise</a></li><li><a href="${link('pages/support.html')}">Support us</a></li></ul></div></div><div class="container footer-bottom"><span>© <span data-year></span> LK Newsroom. All rights reserved.</span><span>Informing Today, Inspiring Tomorrow</span></div></footer>`;
  enhanceFooterAccordion(el);
}

function enhanceFooterAccordion(footer){
  const main=footer.querySelector('.footer-main');if(!main)return;
  const section=(title,items)=>`<details class="footer-section" open><summary>${title}<i class="fa-solid fa-chevron-down" aria-hidden="true"></i></summary><ul class="footer-links">${items}</ul></details>`;
  const categoryLinks=categories.slice(0,6).map(([name])=>`<li><a href="${categoryUrl(name)}">${name}</a></li>`).join('');
  main.innerHTML=`<div class="footer-brand"><img class="footer-logo" src="${link('assets/lk-newsroom-logo.png')}" alt="LK Newsroom"><p>Independent reporting, clear context and the stories that shape our world.</p><p class="footer-slogan">Informing Today, Inspiring Tomorrow</p></div>${section('Explore',`${categoryLinks}<li><a href="${link('pages/live.html')}">Live Updates</a></li><li><a href="${link('pages/video-news.html')}">Video News</a></li><li><a href="${link('pages/gallery.html')}">Photo Gallery</a></li><li><a href="${link('pages/search.html')}">Search</a></li>`)}${section('Company',`<li><a href="${link('pages/about.html')}">About us</a></li><li><a href="${link('pages/contact.html')}">Contact</a></li><li><a href="${link('pages/advertise.html')}">Advertise</a></li><li><a href="${link('pages/support.html')}">Support us</a></li>`)}${section('Social Media',`<li><a href="https://www.facebook.com/profile.php?id=61570722200277" target="_blank" rel="noopener noreferrer">Facebook</a></li><li><a href="https://www.instagram.com/lk.news.global/" target="_blank" rel="noopener noreferrer">Instagram</a></li><li><a href="https://www.tiktok.com/@lk.news.global1" target="_blank" rel="noopener noreferrer">TikTok</a></li><li><a href="https://www.threads.com/@lk.news.global" target="_blank" rel="noopener noreferrer">Threads</a></li>`)}${section('Legal',`<li><a href="${link('pages/privacy.html')}">Privacy policy</a></li><li><a href="${link('pages/terms.html')}">Terms of use</a></li><li><a href="${link('pages/newsletter.html')}">Newsletter</a></li>`)}`;
}
